...
class CodeExtraction(Action):
    """
    An action that uses an LLM to extract and organize code blocks from text 
    and save them to a specified directory. This version leverages LLM capabilities
    to better understand the code structure and suggest appropriate filenames.
    """
    ...
    def identify_main_file(self, saved_files: Dict[str, str]) -> Optional[str]:
        ...
        Returns the path to the main file if found.
        """
