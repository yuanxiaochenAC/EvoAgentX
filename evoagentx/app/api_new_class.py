...
from evoagentx.app.schemas import (
    ...
    WorkflowStepDefinition, WorkflowCreate, WorkflowUpdate, WorkflowResponse,
...
async def create_workflow(
    ...
    # """Create a new workflow."""
    # try:
    #     # Transform each step into a WorkflowStepDefinition object
    #     steps = workflow.definition.get("steps", [])
    #     validated_steps = []
    #     for step_data in steps:
    #         # Create a WorkflowStepDefinition instance
    #         step = WorkflowStepDefinition(**step_data)
    #         validated_steps.append(step)
        
    #     # Update the workflow definition with validated steps
    #     workflow.definition["steps"] = validated_steps
...
async def delete_workflow(
    ...
    #         completed = await WorkflowService.wait_for_executions_to_complete(workflow_id)
    #         if not completed:
    #             raise HTTPException(status_code=408, detail="Timeout waiting for executions to complete")
