...
try:
    ...
    def display(obj: Any) -> None:
        """Display the specified Python object in console

        Args:
            obj (Any): The Python object to display
        """
        print(obj)

    def HTML(x: str) -> str:
        """Get HTML representation of the specified string

        Args:
            x (str): Input string

        Returns:
            str: Returns input string directly in non-IPython environment
        """
        return x
...
class MiproEvaluator:
    ...
    def _construct_result_table(self, results: list[Tuple[Any, Any, Any]], metric_name: str) -> "pd.DataFrame":
        """
