...
4. Do not translate the query or the output into English unless the query itself is in English.
5. Keep the tone neutral and informative, suitable for a retrieval context.

**Input Query**: {query}

**Output Format**:
Hypothetical Document: [Your generated document in the query's language]
"""

DEFAULT_HYDE_PROMPT = Template(HYDE_IMPLE_)